...
const comments = computed(() => {
  let dataComment = cloneDeep(store.state[ModulePost]?.comments) || [];
...
const getComments = async () => {
  ...
  await store.dispatch(ModulePost + "/getPostComments", pamram);
};
...
const saveComment = async () => {
  let data = models.createPostCommentParam();
  ...
  await store.dispatch(ModulePost + "/insertComment", param);
...
const updateComment = async (comment) => {
  ...
  await store.dispatch(ModulePost + '/updateComment', param);
...
const deleteComment = async (comment) => {
  ...
  await store.dispatch(ModulePost + '/deleteComment', param);
