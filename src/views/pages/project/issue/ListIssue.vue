...
const createColumns = () => [
  {
    ...
    fixed: "left",
    render(row, index) {
      return h("div", {class: 'card-issue-avt', title: row.IssueTypeName}, [h("img", {src: row.IssueTypeAvatar })]);
    },
  },
  {
    title: "Mã vấn đề",
    ...
    render(row, index) {
      ...
      return h("div", {class: "text-hover-primary", onClick: onClick}, row.IssueCode);
    },
  },
  {
    title: "Tiêu đề",
    ...
    render(row, index) {
      ...
      return h("div", {class: "text-hover-primary", onClick: onClick}, row.IssueName);
    },
  },
  {
    title: "Trạng thái",
...
<template>
  <div class="list-issue m-pl16 m-mr16 m-pb16">
    <div class="grid-issue-filter flex-row m-pb8">
      <div class="m-mr16">
        <MButton
          :text="'Lấy dữ liệu'"
