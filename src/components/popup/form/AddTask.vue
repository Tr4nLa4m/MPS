...
import { ModuleProject, ModuleContext, ModuleTask } from "@/store/moduleConstant";
...
const getUserProjects = computed(() => {
  ...
  projectData.forEach(project => {
    if(!commonFn.hasPermissionInProject(userPermissions.value, project.ProjectID, MConstant.ProjectPermissions.Task.Task_Add)){
...
const validateData = (data) => {
  ...
  if(!data.TaskGroup.TaskGroupID){
    res.isValid = false;
    res.errMsg = 'Nhóm công việc không được để trống !' ;
    return res;
  }
    ...
    <template #default>
      <div class="m-h100 overflow-auto">
        <div class="form-task--wrapper">
          <!-- Header form -->
          <div class="form-header flex-jsp m-pt8 m-pb16 m-pr8">
            <div class="text-large m-pl8">Thêm công việc</div>
          ...
          <n-scrollbar trigger="hover" style="max-height: 540px">
            <div class="form-body line">
              <div class="header-task m-mb16">
                <div class="row m-pl12">
                  <div class="form-label m-pb8">Dự án:  <span class="danger">*</span></div>
                  <MTreeSelect
                ...
                <div class="row m-pl16">
                  <div class="form-label m-pb8">Nhóm công việc: <span class="danger">*</span></div>
                  <MTreeSelect
                    :data="taskGroups"
