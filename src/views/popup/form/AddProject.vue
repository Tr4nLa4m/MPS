...
const defaultPermissionGroups = computed(
  () => store.state[ModuleUser]?.permissionGroups
);
...
const getInitPermissionGroups = async () => {
  await store.dispatch(ModuleUser + "/getInitPermissionGroups");
};
    ...
    <template #default>
      <div class="form-project--wrapper">
        ...
        <div class="form-body">
          ...
          <div class="">
            <div class="flex-row pb-8 flex-jsp">
              <div class="form-label m-pb8">Thành viên ({{ master.Employees?.length }})</div>
            ...
            <div class="border employees">
              <n-scrollbar style="max-height: 135px">
                <div
                  class="flex-row flex-align-center m-pt8"
