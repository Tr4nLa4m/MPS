...
<template>
  <div class="config-post m-pl16 m-mr16 m-pb16">
    <n-scrollbar :style="`max-height: 600px`">
      <div class="flex-row m-pb8">
        <div class="list-content">
          <div class="config-post-header">
            <div class="">
              <div class="text-large">Thiết lập</div>
            </div>
          </div>

          <div class="config-post-content">
            <div class="tabs m-pl8 m-pr8">
                <n-tabs type="line" animated class="m-tabs">
              <n-tab-pane name="Category" tab="Danh mục">
                <CategoryTab></CategoryTab
              ></n-tab-pane>
              <n-tab-pane name="Tag" tab="Nhãn">
                <TagTab></TagTab>
              </n-tab-pane>
            </n-tabs>
            </div>
