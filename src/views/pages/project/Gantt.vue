  ...
  <div class="ml-3 mr-3">
    <div class="toolbox">
      <div class="flex items-center">
        <label for="countries" class="block mb-2 mr-2 mt-1 text-lg font-medium text-gray-900 dark:text-white">Filter: </label>
        <select id="countries" v-model="selectedOption" @change="handleChange"
